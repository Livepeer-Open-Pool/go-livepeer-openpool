...
const (
	TicketRedeemer_QueueTicket_FullMethodName     = "/net.TicketRedeemer/QueueTicket"
	TicketRedeemer_MaxFloat_FullMethodName        = "/net.TicketRedeemer/MaxFloat"
	TicketRedeemer_MonitorMaxFloat_FullMethodName = "/net.TicketRedeemer/MonitorMaxFloat"
)
...
func (c *ticketRedeemerClient) QueueTicket(ctx context.Context, in *Ticket, opts ...grpc.CallOption) (*QueueTicketRes, error) {
	...
	err := c.cc.Invoke(ctx, TicketRedeemer_QueueTicket_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ticketRedeemerClient) MaxFloat(ctx context.Context, in *MaxFloatReq, opts ...grpc.CallOption) (*MaxFloatUpdate, error) {
	...
	err := c.cc.Invoke(ctx, TicketRedeemer_MaxFloat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ticketRedeemerClient) MonitorMaxFloat(ctx context.Context, in *MaxFloatReq, opts ...grpc.CallOption) (TicketRedeemer_MonitorMaxFloatClient, error) {
	stream, err := c.cc.NewStream(ctx, &TicketRedeemer_ServiceDesc.Streams[0], TicketRedeemer_MonitorMaxFloat_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _TicketRedeemer_QueueTicket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TicketRedeemer_QueueTicket_FullMethodName,
	}
...
func _TicketRedeemer_MaxFloat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TicketRedeemer_MaxFloat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

...
func (c *orchestratorClient) GetOrchestrator(ctx context.Context, in *OrchestratorRequest, opts ...grpc.CallOption) (*OrchestratorInfo, error) {
	...
	err := c.cc.Invoke(ctx, Orchestrator_GetOrchestrator_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orchestratorClient) EndTranscodingSession(ctx context.Context, in *EndTranscodingSessionRequest, opts ...grpc.CallOption) (*EndTranscodingSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Orchestrator_EndTranscodingSession_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AIWorkerClient interface {
	...
	RegisterAIWorker(ctx context.Context, in *RegisterAIWorkerRequest, opts ...grpc.CallOption) (AIWorker_RegisterAIWorkerClient, error)
}
...
func (c *aIWorkerClient) RegisterAIWorker(ctx context.Context, in *RegisterAIWorkerRequest, opts ...grpc.CallOption) (AIWorker_RegisterAIWorkerClient, error) {
	stream, err := c.cc.NewStream(ctx, &AIWorker_ServiceDesc.Streams[0], AIWorker_RegisterAIWorker_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &aIWorkerRegisterAIWorkerClient{stream}
...
type AIWorker_RegisterAIWorkerClient interface {
	Recv() (*NotifyAIJob, error)
	grpc.ClientStream
}

type aIWorkerRegisterAIWorkerClient struct {
	grpc.ClientStream
}

func (x *aIWorkerRegisterAIWorkerClient) Recv() (*NotifyAIJob, error) {
	m := new(NotifyAIJob)
...
type AIWorkerServer interface {
	// Called by the aiworker to register to an orchestrator. The orchestrator
	// notifies registered aiworkers of jobs as they come in.
	RegisterAIWorker(*RegisterAIWorkerRequest, AIWorker_RegisterAIWorkerServer) error
...
func (UnimplementedAIWorkerServer) RegisterAIWorker(*RegisterAIWorkerRequest, AIWorker_RegisterAIWorkerServer) error {
...
func _AIWorker_RegisterAIWorker_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AIWorkerServer).RegisterAIWorker(m, &aIWorkerRegisterAIWorkerServer{stream})
}

type AIWorker_RegisterAIWorkerServer interface {
	Send(*NotifyAIJob) error
	grpc.ServerStream
}

type aIWorkerRegisterAIWorkerServer struct {
	grpc.ServerStream
}

func (x *aIWorkerRegisterAIWorkerServer) Send(m *NotifyAIJob) error {
...
func (c *transcoderClient) RegisterTranscoder(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (Transcoder_RegisterTranscoderClient, error) {
	stream, err := c.cc.NewStream(ctx, &Transcoder_ServiceDesc.Streams[0], Transcoder_RegisterTranscoder_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
